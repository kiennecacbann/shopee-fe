...
import { BsQuestionCircle, BsCartPlus } from "react-icons/bs";
const Product = () => {
  const productImg = {
    img1: "https://down-vn.img.susercontent.com/file/e8110c236c1ebc0edab92749b9173400",
    img2: "https://down-vn.img.susercontent.com/file/c97974b2b68c126ea0d843e93f7b9f4c",
    img3: "https://down-vn.img.susercontent.com/file/c59bb6908d68568200220613a4cf9f63",
    img4: "https://down-vn.img.susercontent.com/file/1c891c3ecda4ab5462e5ff44c28ce2d2",
  };
  return (
            ...
            <div className="">
              <div className="product-container-item">
                <div className="product-container-items">
                  <Link className="text-[#0055AA]">Shopee</Link>
                  <MdArrowForwardIos />
                </div>
                <div className="product-container-items">
                  <Link className="text-[#0055AA]">Home Appliances</Link>
                  <MdArrowForwardIos />
                </div>
                <div className="product-container-items">
                  <Link className="text-[#0055AA]">Vacuums & Floor Care</Link>
                  <MdArrowForwardIos />
                </div>
                <div className="product-container-items">
                  <Link className="text-[#0055AA]">
                ...
                <div className=" truncate text-ellipsis ">
                  <span className="text-[14px]">
                    Máy hút bụi giường nệm, máy hút bụi mini không dây sạc pin
                    có tia UV khử khuẩn, hút ẩm không khí, chăn ga, ghế sofa M2
                  </span>
                </div>
              </div>
              <div className="bg-[#fefffe] mt-5">
                <div className="flex items-center">
                  <div className="">
                    <div className="w-[450px] p-[15px] shrink-0">
                      <div className="flex-col flex">
                        <div className="mb-2">
                          <img
                            className="max-h-[450px] h-[450px] max-w-[450px]"
                            src={productImg.img1}
                          />
                        </div>
                        <div className="relative">
                          <div className="inline-block p-1 box-border w-[20%] visible">
                            <div className="relative visible block">
                              <div className="relative visible block">
                                <div className="bg-product-background bg-no-repeat bg-contain w-full h-full bg-center"></div>
                              </div>
                              <div className="absolute top-0 left-0 bottom-0 right-0 border-[2px] border-solid border-[#ee4d2d]"></div>
                            </div>
                          </div>
                          <div className="inline-block p-1 box-border w-[20%] visible">
                            <div className="relative visible block">
                  ...
                  <div className="flex w-0 flex-grow flex-shrink-0">
                    <div className="px-[20px] pt-[35px] flex-col box-border w-full flex-auto">
                      <div className="m-0 text-ellipsis text-[1.25rem] max-w-[665px] max-h-[48px] align-sub break-words font-medium leading-6">
                        <p>
                          Máy hút bụi giường nệm, máy hút bụi mini không dây sạc
                          pin có tia UV khử khuẩn, hút ẩm không khí, chăn ga,
                          ghế sofa M2
                        </p>
                      </div>
                      <div className="flex relative mt-[10px]">
                        ...
                        <div className="flex cursor-pointer items-center space-x-1 px-[15px]">
                          <div>3,3k</div>
                          <div>Ratings</div>
                        </div>
                        <div className="flex cursor-pointer items-center space-x-1 px-[15px]">
                        ...
                        <div className="justify-end ml-auto">
                          <button className="text-[#0000008A] text-[14px]">
                            Report
                          </button>
                        </div>
                      </div>
                      <div className="mt-[10px]">
                        <div className="flex flex-col">
                          <div className="flex flex-col py-[15px] px-[20px] bg-[#fafafa]">
                            <div className="flex items-center">
                              <div className="flex items-center flex-wrap w-[625px] basis-[625px] min-h-[1.875rem]">
                                <div className="text-[16px] line-through text-[#929292] mr-[10px]">
                                  ₫210.000
                                </div>
                                <div className="flex items-center">
                                  <div className="text-[30px] font-medium text-[#ee4d2d]">
                                    ₫155.000
                                  </div>
                                  <div className="ml-[15px] text-[12px] text-[#fff] uppercase bg-[#ee4d2d] rounded-sm px-[4px] py-[2px] font-semibold leading-none whitespace-nowrap ">
                                    26% off
                                  </div>
                                </div>
                              </div>
                            ...
                            <Link className="mt-3">
                              <div className="flex items-center space-x-2 text-[14px] text-[#555555]">
                                <svg
                                  viewBox="0 0 108 21"
                                  height="21"
                                  width="108"
                                  class="flash-sale-logo flash-sale-logo--default"
                                >
                                ...
                                <div className="">Starts at 19:00, 4 Aug</div>
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="flex flex-col ml-1 mt-1">
                                ...
                                <div className="text-[12px] text-[#0000008a] mt-1">
                      ...
                      <div className="mt-7">
                        <div>
                          <div className=" space-y-5 p-1">
                            <div className="flex items-center">
                              <label className="product-items-label">
                                Shop Vouchers
                              </label>
                              <div className="flex items-center space-x-4">
                                <div className="max-w-full cursor-default flex items-center justify-center z-[1] bg-[#fbebed] py-[3px] px-[7px] border-0 whitespace-nowrap text-[#ee4d2d]">
                                  <span>20</span>
                                  <span>%</span>
                                  <span>OFF</span>
                                </div>
                            ...
                            <div>
                              <div className="flex items-center">
                                ...
                                <button className="relative overflow-visible outline-0 bg-transparent rounded-sm max-w-[450px] px-[6px] py-[3px] cursor-pointer border-solid border-[1px] border-[#ee4d2d]">
                                  <div className="text-[#ee4d2d] whitespace-nowrap text-ellipsis overflow-hidden">
                                    Any 2 enjoy ₫2.000 off
                                  </div>
                                </button>
                              </div>
                            </div>
                            <div>
                              <div className="flex items-center">
                                ...
                                <div>Bảo hiểm Thiết bị điện tử</div>
                                <div className="bg-[#ee4d2d] rounded-r-lg rounded-tl-lg text-white text-[10px] font-medium h-[16px] leading-4 ml-[5px] px-[5px] py-0 ">
                                  New
                                </div>
                                <Link>
                                  <div className="text-[14px] text-[#0088ff] ml-[20px]">
                                    Learn More
                                  </div>
                                </Link>
                              </div>
                              ...
                              <div className="flex text-[14px]">
                                ...
                                <div>
                                  ...
                                  <div className="flex space-x-2 mt-3">
                                    <div>
                                      <MdOutlineLocalShipping className="h-7 w-7" />
                                    </div>
                                    <div className="flex flex-col">
                                      <div className="flex items-center">
                                        <div className="text-[#636363] mr-14">
                                          Shipping To
                                        </div>
                                      ...
                                      <div className="flex items-center mt-2">
                                        <div className="text-[#636363] mr-12">
                                          Shipping Fee
                                        </div>
                                        <div className="flex items-center space-x-1">
                                          <div>₫0</div>
                              ...
                              <div className="flex flex-col">
                                <div className="flex items-center mt-4">
                                  ...
                                  <div className="flex items-center flex-row">
                                    <div>
                                      <div className="h-8 w-full bg-[#fff] flex items-center">
                                        <button className="bg-transparent text-center text-[30px] items-center flex justify-center border-solid border-[1px] border-gray-200 h-8 w-8 outline-none cursor-pointer font-light leading-none tracking-normal">
                                          -
                                        </button>
                                        <input
                                          type="text"
                                          className="w-[50px] text-center h-8 text-[16px] font-normal box-border cursor-text leading-none tracking-normal border-solid border-y-[1px] border-gray-200"
                                          name=""
                                          value="1"
                                        ></input>

                                        <button className="bg-transparent text-center text-[25px] items-center flex justify-center border-solid border-[1px] border-gray-200 h-8 w-8 outline-none cursor-pointer font-light leading-none tracking-normal">
                                          +
                                        </button>
                                      </div>
                                    </div>
                                    <div className="text-[#757575] text-[14px] ml-3">
                                      29317 pieces available
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div>
                              <div className="flex visible cursor-auto space-x-4">
                                <button type="button" className="flex-row font-medium flex items-center space-x-2 min-w-[80px] max-w-[250px] text-[16px] h-[48px] px-[20px] text-ellipsis box-border justify-center capitalize cursor-pointer relative overflow-visible outline-none border-[1px] border-solid border-[#ee4d2d] text-[#ee4d2d] bg-[#FF57221A] rounded-sm">
                                  <BsCartPlus className="h-5 w-5" />
                                  <span>Add To Cart</span>
                                </button>
                                <button type="button" className="min-w-[80px] max-w-[250px] text-[16px] h-[48px] px-5 text-ellipsis flex-col box-border rounded-sm cursor-pointer capitalize items-center flex justify-center text-white relative visible outline-none bg-[#ee4d2d]">Buy Now</button>
                              </div>
                            </div>
                          </div>
                        </div>
